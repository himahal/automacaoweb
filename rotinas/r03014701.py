...
def executar(driver, wait, data_inicio, data_fim, janela_menu):
    ...
    try:
        ...
        todasU = wait.until(EC.presence_of_element_located((By.NAME, "selecionaUnidade")))
        driver.execute_script("arguments[0].scrollIntoView(true);", todasU)
        todasU.click()

        pedidosExcluidos = wait.until(EC.presence_of_element_located((By.NAME, "pedidosExcluidos")))
        driver.execute_script("arguments[0].scrollIntoView(true);", pedidosExcluidos)
